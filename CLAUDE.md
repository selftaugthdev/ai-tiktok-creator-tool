...
script_gen.py         — Anthropic API call, returns list[dict] with headline/body/chart_data
carousel_renderer.py  — Pillow rendering (pink bg, fonts, illustration/chart compositing, accent bar)
